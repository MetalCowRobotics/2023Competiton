   ...
   private final Joystick operator = new Joystick(1);
    ...
    public RobotContainer() {
        ...
        ServoMotorSubsystem.ServoMotorSubsystemConfig shoulderConfig = new ServoMotorSubsystem.ServoMotorSubsystemConfig();
            ...
            shoulderConfig.stallCurentLimit = 60;
            shoulderConfig.freeCurentLimit = 60;
            shoulderConfig.kP = 0.0002;
            shoulderConfig.kI = 0;
            shoulderConfig.kD = 0;
            shoulderConfig.positionTolerance = 2;
            shoulderConfig.minRPM = 1500;
            shoulderConfig.maxRPM = 1700;
        ...
        ServoMotorSubsystem.ServoMotorSubsystemConfig elbowConfig = new ServoMotorSubsystem.ServoMotorSubsystemConfig();
            ...
            elbowConfig.kP = 0.0002;
            elbowConfig.kI = 0;
            elbowConfig.kD = 0;
            elbowConfig.positionTolerance = 2;
            elbowConfig.minRPM = 1800;
            elbowConfig.maxRPM = 2000;
    ...
    public void configureButtonBindings() {
        ...
        midScoringPosition.onTrue(
            new SequentialCommandGroup(
                new InstantCommand(
                    () -> m_shoulderSubsystem.setTarget(65.0)
                ),
                new InstantCommand(
                    () -> m_elbowSubsystem.setTarget(42.2)
                ), 
                new InstantCommand(
                    () -> m_wristSubsystem.setTarget(65.5)
                ),
                new InstantCommand(
        ...
        // coneFloorIntakePosition.onTrue(new InstantCommand(() -> m_shoulderSubsystem.setTarget(90)));
