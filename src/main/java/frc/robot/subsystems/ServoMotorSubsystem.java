...
public abstract class ServoMotorSubsystem extends SubsystemBase {
    ...
    public void setTarget(double target) {
        ...
        this.setpoint = Units.degreesToRotations((target - initialPosition) * reduction);
    }

    public boolean atTarget() {
        return Math.abs(setpoint - getCurrentAngle()) < positionTolerance;
    }
    ...
    public void periodic() {
        ...
        if (!atTarget()) {
            speed = m_pidController.calculate(encoder.getPosition());
        }
